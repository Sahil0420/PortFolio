...
export default function Contact() {
  ...
  const socialLinks = [
    { icon: BiLogoGmail, href: "mailto:sahilchandel4200@gmail.com" },
    { icon: IoLogoLinkedin, href: "https://www.linkedin.com/in/sahil-chandel-a02779292" },
        ...
        >
          ...
          <div className='font-semibold text-sm lg:text-xl flex flex-col mt-6 gap-2 lg:gap-4'>
            ...
            >
              ...
              sahilchandel4200@gmail.com
            </motion.a>

            <motion.a
              whileHover={{ x: 5 }}
              className='flex items-center gap-2 group'
              href="tele:8988350276"
            >
